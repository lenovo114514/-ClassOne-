...
/** @type {string} */
const CACHE_VERSION = '1759563070|19512362578';
/** @type {string} */
const CACHE_PREFIX = '日志Class One-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'ClassOneDiary.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["ClassOneDiary.html","ClassOneDiary.js","ClassOneDiary.offline.html","ClassOneDiary.icon.png","ClassOneDiary.apple-touch-icon.png","ClassOneDiary.audio.worklet.js","ClassOneDiary.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["ClassOneDiary.wasm","ClassOneDiary.pck"];
